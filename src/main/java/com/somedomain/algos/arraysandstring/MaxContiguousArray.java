...
public class MaxContiguousArray {
    ...
    public static int findMaxSumInContiguousSubarray(ArrayList<Integer> sourceArray) {
        ...
        Integer maxNewSum = 0;
        for (int counter = maxSumIdx; sumArr.get(counter) > 0 && counter >= 0; counter--) {
            Integer num = sumArr.get(counter);
